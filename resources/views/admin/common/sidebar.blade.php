    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <a href="{{URL::to('admin/dashboard/this_month')}}"></a><img src="{{asset('').auth()->guard('admin')->user()->image}}" class="img-circle" alt="{{ auth()->guard('admin')->user()->first_name }} {{ auth()->guard('admin')->user()->last_name }} Image">
        </div>
        <div class="pull-left info">
          <p>{{ auth()->guard('admin')->user()->first_name }} {{ auth()->guard('admin')->user()->last_name }}</p>
          <a href="{{URL::to('admin/dashboard/this_month')}}"><i class="fa fa-circle text-success"></i> {{ trans('labels.online') }}</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <a href="{{URL::to('admin/addnewscategory')}}">
         ...
         @endif
        @if(session('customers_view') > 0  or auth()->guard('admin')->user()->adminType=='1')
        ...
        <li class="treeview {{ Request::is('admin/statscustomers') ? 'active' : '' }} {{ Request::is('admin/outofstock') ? 'active' : '' }} {{ Request::is('admin/statsproductspurchased') ? 'active' : '' }} {{ Request::is('admin/statsproductsliked') ? 'active' : '' }} {{ Request::is('admin/lowinstock') ? 'active' : '' }}">
          <a href="{{URL::to('admin/statsproductspurchased')}}">
...
<span> {{ trans('labels.link_general_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
          	<li class="{{ Request::is('admin/profile') ? 'active' : '' }} {{ Request::is('admin/profile') ? 'active' : '' }} {{ Request::is('admin/profile/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/profile')}}}"><i class="fas fa-user"></i> {{ trans('labels.Profile') }}</a></li>
...
<span> {{ trans('labels.Manage Admins') }}</span> <i class="fa fa-angle-left pull-right"></i>
         ...
         <hr style="background: red; height: 5px;">
          <button class="btn btn-info" style="width: 200px; color: red;">
            <li style="" class="treeview {{ Request::is('admin/logout') ? 'active' : '' }}  {{ Request::is('admin/logout') ? 'active' : '' }}  {{ Request::is('admin/logout/*') ? 'active' : '' }}">
          <a style="width: 150px; color: red;" href="{{ URL::to('admin/logout')}}" class="btn btn-warning btn-flat">{{ trans('labels.sign_out') }}<i class="fa fa-logout"></i></a>
        </li>
          </button>     
      </ul>
    </section>
