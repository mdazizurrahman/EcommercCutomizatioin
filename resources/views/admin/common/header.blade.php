      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
                    ...
                    <a href="{{ URL::to("admin/vieworder")}}/{{ $unseenOrder->orders_id}}">
                      <div class="pull-left">
                         ...
                         @if(!empty($unseenOrder->customers_picture))
                            ...
                            @else
                            <img src="{{asset('').'assets/images/default_images/user.png' }}" class="img-circle" alt="{{ $unseenOrder->customers_name }} Image">
                         @endif
                    ...
                    <a href="{{ URL::to("admin/editcustomers")}}/{{ $newCustomer->customers_id}}">
                      <div class="pull-left">
                         @if(!empty($newCustomer->customers_picture))
                            ...
                            @else
                            <img src="{{asset('').'/assets/images/default_images/user.png' }}" class="img-circle" alt="{{ $newCustomer->customers_firstname }} Image">
                         @endif
                      </div>
                      <h4>
          ...
          <li class="dropdown user user-menu">
            <a href="{{ URL::to('admin/profile')}}" class="dropdown-toggle" data-toggle="dropdown">
