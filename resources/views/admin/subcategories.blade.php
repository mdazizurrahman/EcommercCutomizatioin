                   ...
                   @if(count($listingSubCategories)>0)
                    ...
                    @if($categories->language_id == '1')
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editsubcategory/{{ $categories->subId }}" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                <a data-toggle="tooltip" data-placement="bottom" title="Delete" href="deletesubcategory/{{ $categories->subId }}"  onclick="return confirm('Are you sure?')" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @endif
                    @endforeach
