  ...
  <div class="login-logo">
  	...
  	@if(empty($web_setting[15]->value) or !file_exists(asset('').$web_setting[15]->value))
        @if($web_setting[66]->value=='1' and $web_setting[67]->value=='0')
      		<img src="{{asset('admin/images/admin_logo/logo-android-blue-v1.png')}}" class="ionic-hide">
        	<img src="{{asset('admin/images/admin_logo/logo-ionic-blue-v1.png')}}" class="android-hide">
        @elseif($web_setting[66]->value=='1' and $web_setting[67]->value=='1' or $web_setting[66]->value=='0' and $web_setting[67]->value=='1')
   			<img src="{{asset('admin/images/admin_logo/logo-laravel-blue-v1.png')}}" class="website-hide">
    	@endif
    @else
