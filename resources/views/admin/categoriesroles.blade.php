                  ...
                  @if(count($result['data'])>0)
                    @foreach ($result['data'] as $key=>$data)
                        <tr>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editcategoriesroles/{{ $data->categories_role_id }}" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                            <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" href="deletecategoriesroles/{{ $data->categories_role_id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
