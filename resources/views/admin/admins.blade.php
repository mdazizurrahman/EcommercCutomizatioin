							...
							<tr>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li role="presentation"><a class="btn btn-info" role="menuitem" tabindex="-1" href="editadmin/{{ $admin->myid }}">{{ trans('labels.editadmin') }}<i class="fas fa-edit"></i></a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a onclick="return confirm('Are you sure?')" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteCustomerFrom" customers_id="{{ $admin->myid }}">{{ trans('labels.Delete') }}<i class="fas fa-trash"></i></a></li>
                                </ul>
                              </li>
                            </ul>
								</td>
