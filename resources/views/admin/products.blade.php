                    ...
                    @foreach ($results['products'] as  $key=>$product)
                    	<tr>
                            ...
                            <ul class="nav table-nav">
                              <li class="nav-item"> 
                                <ul class="nav table-nav">
                                    <li role="presentation"><a class="btn btn-info" role="menuitem" tabindex="-1" href="editproduct/{{ $product->products_id }}">{{ trans('labels.EditProduct') }}</a></li>
                                    @if($product->products_type==1)
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a class="btn btn-default" role="menuitem" tabindex="-1" href="addproductattribute/{{ $product->products_id }}">{{ trans('labels.ProductAttributes') }}</a></li>
                                    @endif
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a class="btn btn-primary" role="menuitem" tabindex="-1" href="addinventory/{{ $product->products_id }}">{{ trans('labels.addinventory') }}</a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a class="btn btn-warning" role="menuitem" tabindex="-1" href="addproductimages/{{ $product->products_id }}">{{ trans('labels.ProductImages') }}</a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a onclick="return confirm('Are you sure?')" class="btn btn-danger" role="menuitem" tabindex="-1" id="deleteProductId" products_id="{{ $product->products_id }}">{{ trans('labels.DeleteProduct') }}</a></li>
                                </ul>
                              </li>
                            </ul>
                            </td>
