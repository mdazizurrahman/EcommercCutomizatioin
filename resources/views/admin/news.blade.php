                   ...
                   @if(count($news)>0)
                    @foreach ($news as  $key=>$new)
                        ...
                        <tr>
                            ...
                            <td>
                            	@if($new->is_feature==1)
                                	<span class="btn btn-success">{{ trans('labels.Yes') }}</span> 
                                @elseif($new->is_feature==0)
                               	 <span class="btn btn-warning">{{ trans('labels.No') }}</span> 
                                @endif
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editnews/{{ $new->news_id }}" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                
                                <a href="deletenews/{{ $new->news_id }}" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteNewsId" news_id="{{ $new->news_id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                   @else
