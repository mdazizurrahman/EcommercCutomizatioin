                   ...
                   @if (count($customers['result']) > 0)
						@foreach ($customers['result']  as $key=>$listingCustomers)
							<tr>
                              ...
                              <li class="nav-item">
                                <ul class="nav table-nav">
                                    <li role="presentation"><a title="{{ trans('labels.Edit') }}" class="btn btn-info" role="menuitem" tabindex="-1" href="editcustomers/{{ $listingCustomers->customers_id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a title="{{ trans('labels.Address') }}" class="btn btn-warning" role="menuitem" tabindex="-1" href="addaddress/{{ $listingCustomers->customers_id }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation"><a onclick="return confirm('Are you sure?')" href="deletecustomers/{{$listingCustomers->customers_id}}" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteCustomerFrom" customers_id="{{ $listingCustomers->customers_id }}">{{ trans('labels.Delete') }}</a></li>
                                </ul>
                              </li>
                            </ul>
								</td>
