                  ...
                  @if(count($manufacturers)>0)
                    @foreach ($manufacturers  as $key=>$manufacturer)
                        <tr>
                            ...
                            <td>
                            	<a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editmanufacturer/{{ $manufacturer->id }}" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                <a id="manufacturerFrom" manufacturers_id='{{ $manufacturer->id }}' data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" href="deletemanufacturer/{{ $manufacturer->id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                    @endforeach
