                        ...
                        @foreach ($result['devices'] as $key=>$device)
                            <tr>
                                ...
                                <td>
                                	...
                                	<a href="devices/{{ $device->id }}" onclick="return confirm('Are you sure?')" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.DeleteDevice') }}" id="deletedeviceId" devices_id ="{{ $device->id }}" class="badge bg-red btn btn-danger">{{ trans('labels.Delete') }}</a>
                               </td>
                            </tr>
                        @endforeach
                    @else
