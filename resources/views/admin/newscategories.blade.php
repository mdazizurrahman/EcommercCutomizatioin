                    ...
                    @foreach ($listingCategories as $key=>$categories)
                        <tr>
                           ...
                           <!-- <td><img src="{{asset('').'/'.$categories->icon}}" alt="" width=" 100px"></td>-->
                            ...
                            <td><a class="btn btn-info" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editnewscategory/{{ $categories->id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                           ...
                           <a href="deletenewscategory/{{ $categories->id }}" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" id="deleteNewsCategroyId" category_id ="{{ $categories->id }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
