                   ...
                   @if(count($result["pages"])>0)
                    @foreach ($result["pages"] as  $key=>$data)
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="editwebpage/{{ $data->page_id }}" class="btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
