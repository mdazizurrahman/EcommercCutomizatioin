...
class AdminCategoriesController extends Controller
{
	...
	public function categories(){
		...
		$categories = DB::table('categories')
		->leftJoin('categories_description','categories_description.categories_id', '=', 'categories.categories_id')->orderBy('categories.categories_id','DESC')
	...
	public function addnewcategory(Request $request){
		...
		if($request->hasFile('newImage') and in_array($request->newImage->extension(), $extensions)){
			...
			$image->move('assets/images/category_images/', $fileName);
			$uploadImage = 'assets/images/category_images/'.$fileName; 
		}	else{
			$uploadImage = '';
		}	
		...
		if($request->hasFile('newIcon') and in_array($request->newIcon->extension(), $extensions)){
			...
			$icon->move('assets/images/category_icons/', $iconName);
			$uploadIcon = 'assets/images/category_icons/'.$iconName; 
		}	else{
			$uploadIcon = '';
		}	
	...
	public function subcategories(){
		...
		->where('subCategories.parent_id', '>', '0')->where('subCategoryDesc.language_id', '1')->where('mainCategoryDesc.language_id', '1')->orderBy('subId','DESC')->paginate(20);
