...
class AdminManufacturerController extends Controller
{
	public function manufacturers(){
		...
		->leftJoin('manufacturers_info','manufacturers_info.manufacturers_id', '=', 'manufacturers.manufacturers_id')->orderBy('manufacturers.manufacturers_id','DESC')
	...
	public function addnewmanufacturer(Request $request){
		...
		if($request->hasFile('newImage') and in_array($request->newImage->extension(), $extensions)){
			...
			$image->move('assets/images/manufacturers_images/', $fileName);
			$uploadImage = 'assets/images/manufacturers_images/'.$fileName; 
		}	else{
			$uploadImage = '';
		}	
