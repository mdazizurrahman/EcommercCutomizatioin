...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
			...
			Route::get('/deletemanufacturer/{id}', 'AdminManufacturerController@deletemanufacturer');
			...
			Route::post('/deletecustomers/{id}', 'AdminCustomersController@deletecustomers');
			...
			Route::get('/deletelanguage/{id}', 'AdminSiteSettingController@deletelanguage');
			...
			Route::get('/deleteSlider/{i}', 'AdminSlidersController@deleteSlider');
			...
			Route::get('/deleteconstantBanner/{id}', 'AdminConstantController@deleteconstantBanner');
			...
			Route::get('/deletedevice/{id}', 'AdminNotificationController@deletedevice');
			...
			Route::get('/deletecoupon/{id}', 'AdminCouponsController@deletecoupon');
			...
			Route::get('/deletenewscategory/{id}', 'AdminNewsCategoriesController@deletenewscategory');
			...
			Route::post('/deletenews/{id}', 'AdminNewsController@deletenews');
			...
			Route::post('/deleteadmin/{id}', 'AdminController@deleteadmin');
